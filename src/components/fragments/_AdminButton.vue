...
import { faRedo, faTrashAlt, faEdit, faCheck, faTimes, faBookOpen, faPlus } from '@fortawesome/free-solid-svg-icons'
library.add( faTrashAlt, faEdit, faCheck, faTimes, faBookOpen, faRedo, faPlus )
