...
<div class="Cooking clearfix">
    ...
    <div class="cooking-content">
        <div class="pan-in-fire">
            <div>
                <img
                    class="cooking-fire"
                    :src="images.fire.imagePath"
                    />
                <img
                    class="cooking-pan"
                    :src="images.pan.imagePath"
                    />
            </div>
            <div>
                <span>
        ...
        <div class="cooking-chalkboard">
            ...
            <div>
                <img :src="images.chalkboard.imagePath"/>
            </div>
        </div>
    </div>
